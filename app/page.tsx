...
export default function Home() {
  ...
  return <main className="app-shell" onDragOver={e=>e.preventDefault()} onDrop={e=>{e.preventDefault();dropped(Array.from(e.dataTransfer.files))}}>
    <aside className="sidebar">
      <button className="brand" onClick={()=>openSection("Library")}><span className="brand-mark"><i/><b>Α</b><i/></span><span><small>THE</small>ALEXANDRIAN<em>OFFLINE LIBRARY</em></span></button>
    ...
    <section className="content" id="top">
      <header><label className="search"><span>⌕</span><input value={query} onChange={e=>setQuery(e.target.value)} placeholder="Search by title or author…"/></label><div className="header-actions"><div className="offline-pill">● OFFLINE</div><div className="avatar">Α</div></div></header>
